...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Estimate fixed scale-free Endoscope1 stereo calibration per session."
    )
    ...
    parser.add_argument(
        ...
        action="append",
        default=None,
        help="Session ID; repeat to select several. Default: discover all sessions.",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "outputs" / "method_2" / "calibration",
    )
